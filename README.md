...
Comparing acedamic performance across genders
...
Create interactive dashboard for score analysis
Visualize score distributions and correlations
Find correlation between subjects
     
## Outcome
The project helps uncover in comprehensive analysis of student performance completed, significant factors influencing academic scores identified, interative visualization tool creation, techinical skills in python data science demonstration.

## Education
Analysis on acedamic students performance

## Dataset Information
Source: Mendeley Open Data Portals https://data.mendeley.com/datasets/dc3797vf3t/1/files/57b43a3a-a060-4247-afd9-cc17dfbf87f7
